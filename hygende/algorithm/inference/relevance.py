...
logger_name = "HyGende - Relevance-Based Inference"


@inference_register.register("relevance")
class RelevanceBasedInference(Inference):
    def __init__(
        self,
        api,
        ...
        for hypothesis in hyp_bank:
            ...
            for idx in indices:
                if idx < len(result):
                    ...
                    print(f"Warning: Index {idx} is out of bounds. Result length is {len(result)}")  

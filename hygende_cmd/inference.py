...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.7,
        help="The threshold for the hypotheses filtering step in the relevance-based inference method.",
    )
    parser.add_argument(
        "--adaptive_num_hypotheses",
        type=int,
        default=5,
        help="The number of hypotheses to use for the relevance-based inference method.",
    )
    parser.add_argument(
        "--adaptive_num_examples",
        type=int,
        default=0,
        help="The number of examples to use per hypothesis for the relevance-based inference method.",
    )
...
def main():
    ...
    if args.inference_style == "relevance" and all(
        [len(hyp_bank[hyp].correct_examples) == 0 for hyp in hyp_bank]
    ):
        logger.info("All hypotheses have 0 correct examples, use weight-based inference")
        args.inference_style = "weight"

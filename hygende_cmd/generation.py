...
def parse_args():
    ...
    parser.add_argument(
        "--task_config_path",
        type=str,
        default="./data/paddle/config.yaml",
...
def main():
    ...
    from hygende.LLM_wrapper import llm_wrapper_register
    from hygende.algorithm.summary_information import (
        SummaryInformation
    )

    from hygende.algorithm.generation import generation_register
    from hygende.algorithm.inference import inference_register
    from hygende.algorithm.replace import replace_register
    from hygende.algorithm.update import update_register, Update
